...
return [
    'ctrl' => [
        ...
        'searchFields' => 'title',
        'iconfile' => 'EXT:sponsoring/Resources/Public/Icons/tx_sponsoring_domain_model_link.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_sponsoring_domain_model_link.pid=###CURRENT_PID### AND tx_sponsoring_domain_model_link.sys_language_uid IN (-1,0)',
                'default' => 0
            ]
        ],
        'l10n_source' => [
