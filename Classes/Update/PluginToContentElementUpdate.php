 ...
 */
#[UpgradeWizard('sponsoring_migratePluginsToContentElementsUpdate')]
class PluginToContentElementUpdate extends AbstractListTypeToCTypeUpdate
{
    protected function getListTypeToCTypeMapping(): array
    {
        return [
            'sponsoring_sponsoring' => 'sponsoring_sponsoring',
        ];
    }

    public function getTitle(): string
    {
        return 'EXT:sponsoring - Migrate plugins to Content Elements';
    }
